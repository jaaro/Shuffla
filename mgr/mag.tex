...
Here Sphinx Search and Shuffla are best. They run with similar speed. It is amazing that Sphinx was able to equal shuffla results because they are working on disk index and shuffla works in RAM memory. Apache Solr is a little bit slower than two winners. PostgreSQL is far behind which is caused by substring and prefix queries.
