...
For this problem real-time indexes are best \cite{SPHINXRT}. Scheme is the same as for PostgreSQL. \todo{Jakie są indeksy, czemu real-time, jak realizowane są zapytania w sensie składniowym}
