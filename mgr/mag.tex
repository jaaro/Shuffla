...
\pawel{mam pewne watpliwosci co do teog okreslenia full-text search engine}
...
\pawel{tutaj przydaloby sie jeszcze kilka zdan dlaczego chcesz pisac wlasny soft}
...
\pawel{tutaj moze wklej jakas przykladowa definicje tabeli}

\subsection{Selecting data}

\pawel{wczesniej piszesz should provide, a potem provides...}
...
\pawel{order pojawia sie w poprzednim i nastepnym zdaniu, moze jakos to sklej, oraz zdefiniuj o jaki order Ci chodzi}
...
\pawel{..can be used: relational databases and full text search engines}
...
\item Inverted Index \pawel{cytowanie}
...
\pawel{potem cos piszesz o static K-D tree, wiec chyba powinienes gdzies wspomniec, ze w takim pivot jest po prostu mediana?}
...
\pawel{to w koncu nie masz losowego wybierania?! co to jest good pivot?}
...
\pawel{mam wrazenie, ze ten rozdzial powinienen byc przed implementacja}
...
\pawel{almost? well? super? pogubilem sie}
