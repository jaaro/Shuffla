...
It looks like Solr is the best with result of average 6.1 requests per second. Shuffla is second with 3.8 requests per second. PostgreSQL is third with 2.6 request per second. \todo{Wnioski}

\section{Summary}

After this discussion you may think that Shuffla is useless. I don't think it's useless. Shuffla fits great for smaller problems like searching through internet forum or blog. Solr or sphinx are requiring not easy installation and configuration. Installation of shuffla takes 2 minutes, creating table takes 10 seconds and searching is very easy. In short/simple projects having possibility of integrating search engine in less than 5 minutes is very welcome. \todo{Inne zastosowania}
